...
from vibe.config import config_exists, load_config
from vibe.secrets.allowlist import validate_allowlist
from vibe.state import set_last_doctor_run
from vibe.wizards.github import check_gh_cli_auth
...
def check_config_schema() -> CheckResult:
    ...
    from vibe.config_schema import validate_config
...
def check_label_sync(config: dict) -> CheckResult:
    ...
    from vibe.config import DEFAULT_CONFIG
...
def check_direnv() -> CheckResult:
    ...
    from vibe.env import check_direnv_status
