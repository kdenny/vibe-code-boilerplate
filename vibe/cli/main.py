...
from vibe.cli.costs import main as costs_group
from vibe.cli.figma import figma
...
from vibe.cli.secrets import main as secrets_group
from vibe.doctor import print_results, run_doctor
from vibe.errors import IntegrationError, MissingExtraError
from vibe.trackers.base import TrackerBase
from vibe.version import bump_version, get_version, write_version
from vibe.wizards.setup import run_individual_wizard, run_setup
...
def main() -> None:
    ...
    try:
        from vibe.update_check import check_for_update, format_update_notice
...
def update(skip: bool, force: bool) -> None:
    ...
    from vibe.update_check import check_for_update, skip_update_check
...
def sync_labels(dry_run: bool, as_json: bool) -> None:
    ...
    from vibe.config import load_config
    from vibe.label_sync import sync_labels_to_config
    from vibe.ui.components import Spinner
    ...
    if tracker_type == "linear":
        ...
        from vibe.trackers.shortcut import ShortcutTracker
...
def do(ticket_id: str) -> None:
    ...
    from vibe.config import load_config
    from vibe.git.branches import format_branch_name, get_main_branch
    from vibe.git.worktrees import create_worktree, get_primary_repo_root
    from vibe.state import record_ticket_branch
    from vibe.trackers.github_issues import GitHubIssuesTracker
    from vibe.trackers.linear import LinearTracker
    from vibe.ui.components import Spinner
...
def _check_local_state_for_ticket_conflicts(
    ...
    *current_branch*, excluding stale (abandoned) records — see
    ...
    """
    from vibe.state import get_branches_for_ticket
...
def pr(title: str | None, body: str | None, web: bool) -> None:
    ...
    from vibe.config import load_config
    from vibe.git.branches import current_branch, get_main_branch
...
# Register secrets commands from vibe.cli.secrets
...
def init_actions(linear: bool, dry_run: bool, include_all: bool, interactive: bool) -> None:
    ...
    """
    from vibe.github_actions import init_github_actions
    from vibe.ui.components import MultiSelect
...
def cors_check(
    ...
    """
    from vibe.cors import check_cors, format_cors_result
...
def retrofit(
    ...
    from vibe.config import load_config
    from vibe.retrofit.analyzer import ActionType, RetrofitAnalyzer
    ...
    from vibe.ui.components import MultiSelect, WhatNextFlow
    from vibe.wizards.setup import run_individual_wizard
