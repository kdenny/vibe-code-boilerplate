...
from vibe.costs.base import CostProvider, CostReport, ManualCostEntry

# Map of provider name -> (module_path, class_name)
PROVIDER_REGISTRY: dict[str, tuple[str, str]] = {
    "vercel": ("vibe.costs.providers.vercel", "VercelCostProvider"),
    "neon": ("vibe.costs.providers.neon", "NeonCostProvider"),
    "supabase": ("vibe.costs.providers.supabase", "SupabaseCostProvider"),
    "fly": ("vibe.costs.providers.fly", "FlyCostProvider"),
    "github": ("vibe.costs.providers.github_actions", "GitHubActionsCostProvider"),
    "openai": ("vibe.costs.providers.openai", "OpenAICostProvider"),
    "anthropic": ("vibe.costs.providers.anthropic", "AnthropicCostProvider"),
    "sentry": ("vibe.costs.providers.sentry", "SentryCostProvider"),
}
